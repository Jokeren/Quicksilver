...
//to-do        mcco->distance_to_facet->task[my_task_num].facet[facet_index].distance = PhysicalConstants::_hugeDouble;
            distance_to_facet = PhysicalConstants::_hugeDouble;
  ...
  //to-do        mcco->distance_to_facet->task[my_task_num].facet[facet_index].distance = t;
           ...
           if ( distance_to_facet > 0.0 ) {
              if ( distance_to_facet <= nearest_facet.distance_to_facet )
              {
                 nearest_facet.distance_to_facet = distance_to_facet;
                 nearest_facet.facet             = facet_index;
              }
           } else { // zero or negative distance
              if ( distance_to_facet > nearest_negative_facet.distance_to_facet )
              {
                 // smallest in magnitude, but negative
                 nearest_negative_facet.distance_to_facet = distance_to_facet;
                 nearest_negative_facet.facet             = facet_index;
              }
           }
         } // for facet_index
         ...
         nearest_facet = MCT_Nearest_Facet_Find_Nearest(
